    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 5,), // Espacio entre el nombre y la localización
          Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Icon(Icons.location_on, color: Colors.grey), // Icono de localización
...
Widget _buildInfoRow3(String text, {String? year}) {
  return Container(
    ...
    padding: EdgeInsets.only(top: 6, right: 12, left: 12, bottom: 6), // Change alignment to top left
    child: Container(
      height: 50,
      child: Row(
        children: [
